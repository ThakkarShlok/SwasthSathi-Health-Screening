...
const TRANSLATION_KEYS = {
    ...
    lang_modal_subheading: 'Select your preferred language to continue',
...
feature_ocr: 'OCR Report Scanning',
    ...
    takes_5min: 'Takes only 5 minutes',
...
feature_doctors_title: 'Specialist Directory',
...
impact_specialists: 'Specialists Listed',
...
impact_time: 'Quick Screening',
    ...
    data_secure: 'Your data is stored securely with encryption',
    ...
    contact_ph_subject: 'What is this about?',
    contact_ph_message: 'Type your message...',
    contact_send: 'Send Message',
    contact_sending: 'Sending...',
    contact_success: 'Thanks — we have received your message.',
    contact_err_required: 'Please fill in all fields.',
    contact_err_email: 'Please enter a valid email address.',
    contact_err_long: 'Your message is too long. Please shorten it.',
    contact_err_rate: 'Please wait a moment before sending another message.',
    contact_err_session: 'You have sent several messages already. Please try again later.',
    contact_err_generic: 'Could not send your message right now. Please try again later.',
    contact_info_title: 'Get in touch',
    contact_info_desc: 'Questions about your screening, feedback on the app, or partnership ideas — send us a note and our team will get back to you.',
    contact_info_reply: 'We usually reply within a few working days.',
    contact_info_privacy: 'Your message is sent to our support inbox only. We never share your details.',

    // ===== EMAIL MY RESULT (Phase 4) =====
    btn_email_result: 'Email My Result',
    email_sent: 'Result emailed to your address.',
    email_cooldown: 'You already emailed this result. Please wait a few minutes before sending again.',
    email_err_generic: 'Could not send the email right now. Please try again in a moment.',
    email_err_unavailable: 'Email is not available right now. Please try the Share button instead.',
    email_err_auth: 'Please log in again to email your result.',
    email_err_link: 'Could not prepare your result link. Please try again.',
    ...
    form_step1_title: 'Basic Info',
    form_step2_title: 'Health',
    form_step3_title: 'Lifestyle',
    form_step4_title: 'Submit',
    btn_next: 'Next',
    btn_previous: 'Back',
    step_progress: 'Step {step} of {total}',

    // ===== RESULT PAGE: GAUGE + FACTORS + COMPLETENESS =====
    result_risk_gauge: 'Risk Level',
    result_contributing_factors: 'Top Contributing Factors',
    result_data_completeness: 'Data Completeness',
    result_completeness_tip: 'More data = higher accuracy',
    gauge_low: 'Low',
    gauge_moderate: 'Moderate',
    gauge_high: 'High',
    gauge_critical: 'Critical',
    completeness_blood_sugar: 'Blood Sugar',
    completeness_blood_pressure: 'Blood Pressure',
    completeness_waist: 'Waist Measurement',
    completeness_symptoms: 'Symptoms',
    completeness_lifestyle: 'Lifestyle Data',

    // ===== RESULT PAGE: GUIDELINE CHAT ASSISTANT (Phase 4) =====
    gc_title: 'Ask About Your Results',
    gc_subtitle: 'Get answers based on published health guidelines',
    gc_intro: 'Ask a question about your screening. Answers come from published health guidelines, not from personal medical advice.',
    gc_placeholder: 'Type your question...',
    gc_thinking: 'Thinking',
    gc_based_on: 'Based on:',
    gc_urgent_title: 'Seek medical care now',
    gc_declined_medication: 'I can’t advise on medicines',
    gc_declined_scope: 'Outside what I can help with',
    gc_chip_diabetes: 'Why is my diabetes risk elevated?',
    gc_chip_hypertension: 'Why is my blood pressure risk elevated?',
    gc_chip_hba1c: 'What does my HbA1c mean?',
    ...
    gc_err_generic: 'I’m having trouble right now, please try again in a moment.',
    gc_err_rate: 'You’ve asked a lot of questions in a short time. Please wait a little and try again.',
    gc_err_auth: 'Please log in again to use the assistant.',
    gc_err_too_long: 'That question is too long. Please shorten it and try again.',

    // ===== FACTOR EXPLANATIONS (result page clinical context) =====
    factor_age_title: 'Age Factor',
    factor_age_context: 'Risk of diabetes and hypertension increases with age. NFHS-5 data shows a 14× higher odds ratio for those above 50 years.',
    factor_obesity_title: 'Obesity',
    factor_obesity_context: 'BMI ≥30 is associated with 12× higher diabetes risk. Excess body fat increases insulin resistance and blood pressure.',
    factor_overweight_title: 'Overweight',
    factor_overweight_context: 'For South Asians, health risks begin at BMI ≥23. Even modest weight reduction improves outcomes.',
    factor_abdominal_obesity_title: 'Abdominal Obesity',
    factor_abdominal_obesity_context: 'Waist >90 cm (men) or >80 cm (women) indicates visceral fat — a key driver of insulin resistance and elevated BP.',
    factor_blood_sugar_high_title: 'Elevated Blood Sugar',
    factor_blood_sugar_high_context: 'Fasting blood sugar ≥126 mg/dL meets the ADA diagnostic criterion for diabetes. Clinical consultation is essential.',
    factor_blood_sugar_prediabetes_title: 'Pre-Diabetes Range',
    factor_blood_sugar_prediabetes_context: 'Fasting blood sugar 100–125 mg/dL is the pre-diabetes range. Lifestyle changes at this stage can prevent progression.',
    factor_blood_pressure_title: 'Blood Pressure Reading',
    factor_blood_pressure_context: 'Elevated blood pressure damages blood vessels over time. JNC-8 defines hypertension as BP ≥140/90 mmHg.',
    factor_diagnosed_diabetes_title: 'Prior Diabetes Diagnosis',
    factor_diagnosed_diabetes_context: 'A prior diabetes diagnosis significantly elevates combined metabolic risk, especially alongside hypertension (60.5% co-occurrence, NFHS-5).',
    factor_diagnosed_hypertension_title: 'Prior Hypertension Diagnosis',
    factor_diagnosed_hypertension_context: 'Existing hypertension raises cardiovascular complication risk. Regular monitoring and treatment adherence are critical.',
    factor_diabetes_symptoms_title: 'Diabetes Symptoms',
    factor_diabetes_symptoms_context: 'Frequent urination, excessive thirst, and unexplained fatigue cluster in early-stage diabetes and should not be ignored.',
    factor_htn_symptoms_title: 'Hypertension Symptoms',
    factor_htn_symptoms_context: 'Persistent headaches, dizziness, and palpitations may indicate elevated blood pressure. A BP reading should be taken promptly.',
    factor_family_history_title: 'Family History',
    factor_family_history_context: 'Having a first-degree relative with diabetes or hypertension raises your own risk by 2–3× due to shared genetic and lifestyle factors.',
    factor_sedentary_title: 'Sedentary Lifestyle',
    factor_sedentary_context: 'Physical inactivity reduces insulin sensitivity and raises BP. Even 30 minutes of walking daily significantly lowers metabolic risk.',
    factor_diet_title: 'Unhealthy Diet',
    factor_diet_context: 'High-fat, high-sugar, and high-salt diets drive weight gain, insulin resistance, and elevated BP — the three pillars of metabolic syndrome.',
    factor_smoking_title: 'Smoking',
    factor_smoking_context: 'Smoking damages blood vessel walls, raises BP, and increases insulin resistance. Risk drops significantly within months of quitting.',
    factor_alcohol_title: 'Frequent Alcohol Consumption',
    factor_alcohol_context: 'Regular alcohol intake raises BP, adds empty calories, and disrupts glucose metabolism — contributing to both diabetes and hypertension risk.',

    // ===== FOOTER =====
    footer_tagline: 'Your trusted companion for early health screening. Evidence-based, multilingual, and free for everyone.',
